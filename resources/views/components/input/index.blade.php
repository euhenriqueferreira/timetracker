...
@if($search)
    <div class="w-[270px] bg-neutral-800 border border-neutral-800 rounded-lg flex items-center justify-between gap-2.5 px-2.5 py-[5px] hover:border-neutral-200 focus:border-neutral-200 transition">
        <input type="text" name="{{ $name }}" id="{{ $name }}" placeholder="{{ $placeholder }}" value="{{ $value }}" class="flex-1 bg-transparent focus:outline-none text-base text-neutral-200">
